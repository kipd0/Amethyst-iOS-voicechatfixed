...
public class PatchSVC implements ClassFileTransformer {
    ...
    private static final String[][] PATCHES = {
        {
            ...
            "de/maxhenkel/rnnoise4j/Denoiser.class.patch"
        },
        {
            "de/maxhenkel/opus4j/OpusDecoder",
            "de/maxhenkel/opus4j/OpusDecoder.class.patch"
        },
        {
            "de/maxhenkel/opus4j/OpusEncoder",
            "de/maxhenkel/opus4j/OpusEncoder.class.patch"
        },
        {
            "de/maxhenkel/lame4j/Mp3Decoder",
            "de/maxhenkel/lame4j/Mp3Decoder.class.patch"
        },
        {
            "de/maxhenkel/lame4j/Mp3Encoder",
            "de/maxhenkel/lame4j/Mp3Encoder.class.patch"
        },
        {
            "de/maxhenkel/speex4j/AutomaticGainControl",
            "de/maxhenkel/speex4j/AutomaticGainControl.class.patch"
        }
    };
    ...
    public byte[] transform(
        ...
        System.out.println(
                "PatchSVC: Replacing class " + className
        );
        ...
        try {
            ...
            if (inputStream == null) {
                System.err.println(
                        "PatchSVC: ERROR - Patch file not found: "
                                + patchFile
                );
                return classfileBuffer;
            }
            ...
            System.out.println(
                    "PatchSVC: SUCCESS - Patched " + className
            );
